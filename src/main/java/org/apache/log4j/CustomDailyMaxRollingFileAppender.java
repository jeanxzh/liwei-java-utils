 ...
 * @version CustomDailyMaxRollingFileAppender.java, v 0.1 May 24, 2012 3:37:46 PM
 */
public class CustomDailyMaxRollingFileAppender extends FileAppender {
    ...
    */
    ...
    public CustomDailyMaxRollingFileAppender() {
    }
    ...
    /**
      ...
      */
    public CustomDailyMaxRollingFileAppender(Layout layout, String filename, String datePattern)
                                                                                                throws IOException {
    ...
    int computeCheckPeriod() {
        RollingPastCalendar rollingPastCalendar = new RollingPastCalendar(gmtTimeZone,
            Locale.ENGLISH);
    ...
    */
    ...
    private String dateBefore() {
        ...
        if (datePattern != null) {
            ...
            dataAnte = simpleDateFormat.format(new Date(rpc.getPastCheckMillis(new Date(),
                maxBackupIndex)));
        }
